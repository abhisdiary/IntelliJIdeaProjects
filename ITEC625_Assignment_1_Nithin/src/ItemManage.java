...
public class ItemManage {
    ...
    public static boolean checkStockValue(int avePrice, int totalVol, int threshold) {
        ...
        //To be completed
        int Stockval = avePrice * totalVol;
    ...
    public static int numOfSoldKind(char item1, char item2, char item3) {
        //To be completed
        int count = 0;
        if (item1 == item2 && item3 == item2)
            count = 1;
        else if (item1 == item2 || item2 == item3 || item3 == item1)
            count = 2;
        else
            count = 3;
        return count;
     ...
     * return 'g' if the number of days is larger than or equal to 0 but no more than 3.
    ...
    public static int itemWithLargerProfit(int vol1, int price1, int cost1, int vol2, int price2, int cost2) {
        //To be completed
        int profit1 = (price1 - cost1) * vol1;
        int profit2 = (price2 - cost2) * vol2;
        if (profit1 < profit2)
            return -1;
